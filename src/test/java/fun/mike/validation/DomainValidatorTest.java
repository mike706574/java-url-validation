...
//      (halfwidth ideographic full stop).
    ...
    public void testGetArray() {
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.COUNTRY_CODE_MINUS));
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.COUNTRY_CODE_PLUS));
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.GENERIC_MINUS));
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.GENERIC_PLUS));
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.COUNTRY_CODE_RO));
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.GENERIC_RO));
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.INFRASTRUCTURE_RO));
        assertNotNull(DomainValidator.getTLDEntries(DomainValidator.ArrayType.LOCAL_RO));
    }
    ...
    public void testUpdateGeneric() {
        ...
        DomainValidator.updateTLDOverride(DomainValidator.ArrayType.GENERIC_MINUS, new String[]{"xx"}); // change the minus list
        assertTrue(validator.isValidGenericTld("com"));
    }
    ...
    public void testCannotUpdate() {
        DomainValidator.updateTLDOverride(DomainValidator.ArrayType.GENERIC_PLUS, new String[]{"ch"}); // OK
